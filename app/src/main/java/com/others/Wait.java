...
//	            		int second = t.second;
				...
				editor.commit();
				//创建一个SQLiteHelper对象
				helper = new DatabaseHelper(Wait.this, newtime.substring(0,10) + ".db");
	...
	protected void dialog() {
		AlertDialog.Builder builder = new Builder(Wait.this);
